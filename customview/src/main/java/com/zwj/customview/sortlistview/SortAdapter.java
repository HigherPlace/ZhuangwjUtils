...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
	...
	public interface OnItemClickListener {
		void onItemClick(int position, SortModel item);
	}
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (position == getPositionForSection(section)) {
			...
			viewHolder.tvLetter.setText(mContent.getSortLetters().substring(0,
					1));
		} else {
		...
		viewHolder.tvTitle.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				if(mOnItemClickListener != null) {
					mOnItemClickListener.onItemClick(position, mContent);
				}
			}
		});
