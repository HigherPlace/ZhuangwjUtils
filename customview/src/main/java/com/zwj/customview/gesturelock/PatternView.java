...
package com.zwj.customview.gesturelock;
...
public class PatternView extends View {
    ...
    // 外圆半径
    private final int mExcircleRadius;
    ...
    // 外圆画笔
    private final Paint mPaintExcircle = new Paint();
    ...
    // 手势显示模式，true - 不显示连接线，false - 显示连接线
    ...
    public static class CellState {
        int row;
        int col;
        float radius;               // 中间实心点的半径
//        float excircleRadius;       // 外圆的半径
        float translationY;
        float alpha = 1f;
    ...
    public PatternView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // TODO 各个节点半径大小需要根据View大小以及设置的节点数量进行动态的设置
    ...
    private void updatePatternSize() {
        ...
        for (int i = 0; i < mRowCount; i++) {
            for (int j = 0; j < mColumnCount; j++) {
                ...
                mCellStates[i][j].radius = mDotRadius;
    ...
    private void startCellActivatedAnimation(Cell cell) {
        ...
        startRadiusAnimation(mDotRadius, mDotRadiusActivated, 96, mLinearOutSlowInInterpolator,
                cellState, new Runnable() {
                    @Override
                    public void run() {
                        startRadiusAnimation(mDotRadiusActivated, mDotRadius, 192,
    ...
    /**
     * 检测当前手指的x、y坐标，获取对应的节点，若是对应的节点已经被选中则返回null
     */
    ...
    private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        protected int getVirtualViewAt(float x, float y) {
            ...
            System.out.println("----------> getVirtualViewAt");
